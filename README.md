...
[![Run on Brainlife.io](https://img.shields.io/badge/Brainlife-bl.app.62-blue.svg)](https://doi.org/10.25663/brainlife.app.62)

# Dipy Reconstruction Diffusion MRI using CSD

The App uses the Constrained Spherical Deconvolution (CSD) method to do a reconstruction of the diffusion-weighted magnetic resonance imaging data.
...
### DIPY
- This is a Brainlife wrapper App stemming from the [`dipy_fit_csd`](https://dipy.org/documentation/latest/reference_cmd/dipy_fit_csd/) workflow.
